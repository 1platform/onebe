...
function DocumentEntity(object: Constructor, propertyName: string, columnOptions?: IExtendedColumnOptions) {
...
export function UpdateDateColumn(options?: IExtendedColumnOptions): PropertyDecorator {
...
export function DeleteDateColumn(options?: IExtendedColumnOptions): PropertyDecorator {
...
export function CreateDateColumn(options?: IExtendedColumnOptions): PropertyDecorator {
  return function (object: Constructor, propertyName: string) {
...
export function VersionColumn(options?: IExtendedColumnOptions): PropertyDecorator {
  return function (object: Constructor, propertyName: string) {
...
export function ObjectIdColumn(options?: IExtendedColumnOptions): PropertyDecorator {
  return function (object: Constructor, propertyName: string) {
