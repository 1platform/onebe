...
const defaultDBConfig = {
   ...
   * @default "mongoose"
   */
  configuration: _Env.default.string("DATABASE_CONFIGURATION", "mongoose"),
  ...
  mysql: {
     ...
     * @default false
     */
    bigNumberStrings: _Env.default.flag("DATABASE_MYSQL_BIG_NUMBERS") ?? false,
     ...
     * @default "Z"
     */
    timezone: _Env.default.string("DATABASE_MYSQL_TIMEZONE", "Z")
  },
  ...
  entities: {
     ...
     */
    files: [_Env.default.string("DATABASE_ENTITIES", "./src/entities/**/*.ts")],
     ...
     */
    folder: [_Env.default.string("DATABASE_ENTITIES_FOLDER", "./src/entities/")]
  },
  ...
  seeds: {
     ...
     * @default "./src/seeds/"
     */
    folder: _Env.default.string("DATABASE_SEEDS_FOLDER", "./src/seeds/")
  }
};
