...
| Name | Type | Description |
| :------ | :------ | :------ |
| `strategy` | ``"uuid"`` \| ``"increment"`` \| ``"rowid"`` \| `PrimaryGeneratedColumnNumericOptions` \| ``"identity"`` | The strategy used for generating the primary key or the list of options used for                 defining the generated primary key column. |
