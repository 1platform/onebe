[Spark OneBE - v1.0.25](../README.md) / [Exports](../modules.md) / [Utils/OtherUtils](../modules/Utils_OtherUtils.md) / [QRCode](../modules/Utils_OtherUtils.QRCode.md) / QRCodeToFileStreamOptions

# Interface: QRCodeToFileStreamOptions

[Utils/OtherUtils](../modules/Utils_OtherUtils.md).[QRCode](../modules/Utils_OtherUtils.QRCode.md).QRCodeToFileStreamOptions
...
- [color](Utils_OtherUtils.QRCode.QRCodeToFileStreamOptions.md#color)
- [errorCorrectionLevel](Utils_OtherUtils.QRCode.QRCodeToFileStreamOptions.md#errorcorrectionlevel)
- [margin](Utils_OtherUtils.QRCode.QRCodeToFileStreamOptions.md#margin)
- [rendererOpts](Utils_OtherUtils.QRCode.QRCodeToFileStreamOptions.md#rendereropts)
- [scale](Utils_OtherUtils.QRCode.QRCodeToFileStreamOptions.md#scale)
- [toSJISFunc](Utils_OtherUtils.QRCode.QRCodeToFileStreamOptions.md#tosjisfunc)
- [type](Utils_OtherUtils.QRCode.QRCodeToFileStreamOptions.md#type)
- [version](Utils_OtherUtils.QRCode.QRCodeToFileStreamOptions.md#version)
- [width](Utils_OtherUtils.QRCode.QRCodeToFileStreamOptions.md#width)
